...
スキルチェックリスト ver.6 を横断検索・参照できるビューアーです。  
以下リンクより参照ください。  
https://the-japan-datascientist-society.github.io/skills-checklist-viewer/

## 機能

- 5セクション（基盤・価値創造力・データサイエンス力・データエンジニアリング力・融合スキル）を1ページで表示
- 全セクション横断の全文検索
- 左サイドバーからセクションへのジャンプ・スクロールスパイ
- カテゴリ単位の折りたたみ
...
チェックリストの詳細は[こちら](https://speakerdeck.com/datascientistsociety/12thsymp_skill)
